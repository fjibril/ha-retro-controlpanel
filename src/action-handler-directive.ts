...
customElements.define('action-handler-retro-controlpanel', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-retro-controlpanel')) {
    return body.querySelector('action-handler-retro-controlpanel') as ActionHandler;
  }

  const actionhandler = document.createElement('action-handler-retro-controlpanel');
